    ...
    <div>
      <section className="py-10 mt-30 my-auto dark:bg-gray-900">
        <div className="lg:w-[80%] md:w-[90%] w-[96%] mx-auto flex gap-4">
          <div className="lg:w-[88%] sm:w-[88%] w-full mx-auto shadow-md  p-4 rounded-xl h-fit self-center">
            <div className="">
              <form>
                <div className="flex flex-col lg:flex-row gap-2 justify-center w-full">
                  <div className="w-full  mb-4 mt-6">
                    ...
                    <input
                      ...
                      type="text"
                      className="mt-2 p-2 w-full border-2 rounded-lg dark:text-gray-200 border-gray-200"
                ...
                <div className="flex gap-3 justify-end">
                  <div className="rounded-lg bg-red-500 mt-4 text-white text-md font-semibold">
                    ...
                    >
                      {isLoading ? "Loading..." : "Supprimer mon compte"}
                    </button>
                  </div>
